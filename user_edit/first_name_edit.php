<?php
	...
	*/
	function update(){
		$update_sql = 'update users set first_name = ? where user_id = ?';
		Dao::db()->mod_exec($update_sql,array($_REQUEST['firstname'],$_SESSION['login']));
	}
	/**
	*POST時処理
	*/
...
<html lang="ja">
	...
	<div class="offset-md-3 col-md-6 text-center mt-3 mb-3">
		<form method="post" enctype="multipart/form-data">
			...
			<input type="text" class="form-control" name="firstname" value="<?php echo $user['data']['first_name']?>">
			</div>
			<br>
