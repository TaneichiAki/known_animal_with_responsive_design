<?php
	...
	*/
	function update(){
		$update_sql = 'update users set last_name = ? where user_id = ?';
		Dao::db()->mod_exec($update_sql,array($_REQUEST['lastname'],$_SESSION['login']));
	}
	/**
	*POST時処理
	*/
...
<html lang="ja">
	...
	<div class="offset-md-3 col-md-6 text-center mt-3 mb-3">
		<form method="post" enctype="multipart/form-data">
			...
			<input type="text" class="form-control" name="lastname" value="<?php echo $user['data']['last_name']?>">
			</div>
			<br>
